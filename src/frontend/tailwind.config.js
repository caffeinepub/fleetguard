  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        warning: { DEFAULT: "oklch(var(--warning) / <alpha-value>)", foreground: "oklch(var(--warning-foreground))" },
      ...
      boxShadow: {
        ...
        card: "0 1px 3px oklch(0 0 0 / 0.06), 0 4px 12px oklch(0 0 0 / 0.04)",
        elevated: "0 4px 20px oklch(0 0 0 / 0.10), 0 1px 4px oklch(0 0 0 / 0.06)",
        "elevated-lg": "0 8px 32px oklch(0 0 0 / 0.14), 0 2px 8px oklch(0 0 0 / 0.08)",
      },
      keyframes: {
